...
export default function Globe() {
  ...
  useEffect(() => {
   ...
   `;
    ...
    atmosphereMesh.position.x = 2; // Move to the right
    ...
    wireframeGlobe.position.x = 2; // Move to the right
    ...
    solidGlobe.position.x =2; // Move to the right
    ...
    const hintTimer = setTimeout(() => {
      setShowHint(false);
    }, 5000); // Hide hint after 3 seconds
  ...
  return (
    <div ref={mountRef} className="w-full min-h-full z-0">
      {showHint && (
